...
ubuntu_usage: ## [DEBUG] UBUNTU : VERIF RAM, DISK, CPU
	@echo "--- RAM ---"
	@free -h
	@echo ""
	@echo "--- DISK ---"
...
docker-reset-for-full-simu: ## [DEBUG] Reset DVC (lock/cache) et data (raw/preprocessed) pour simu propre
	...
	@echo "--- .dvc/cache/ ---" && ls -A .dvc/cache/
	@echo "--- data/raw/ ---" && ls -A data/raw/
	@echo "--- data/preprocessed/ ---" && ls -A data/preprocessed/
